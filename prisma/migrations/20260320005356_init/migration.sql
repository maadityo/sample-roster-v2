-- CreateEnum
CREATE TYPE "Role" AS ENUM ('KAKAK', 'ADMIN');
...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "role" "Role" NOT NULL DEFAULT 'KAKAK',
...
-- CreateIndex
CREATE UNIQUE INDEX "Absence_userId_scheduleId_key" ON "Absence"("userId", "scheduleId");
...
-- AddForeignKey
ALTER TABLE "Absence" ADD CONSTRAINT "Absence_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "Schedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
